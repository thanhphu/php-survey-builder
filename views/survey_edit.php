...
<head>
  ...
  <script type="text/javascript">
    var questionHtml = <?php ob_start();
                        include 'survey_edit_question.php';
                        echo json_encode(ob_get_clean()); ?>;
    var choiceHtml = <?php ob_start();
        ...
        <?php if (!empty($survey) && $survey instanceof Survey) : ?>
          <form id="survey_edit_form" action="survey_edit.php" method="post">
            ...
            <div class="input_form survey_edit">
              ...
              <div>
                <label>User ID prompt:</label>
                <input type="text" id="survey_id_prompt" name="survey_id_prompt" value="<?php echo htmlspecialchars($survey->survey_id_prompt); ?>" />
              </div>
              <div>
                <label>Submit button text:</label>
                <input type="text" id="survey_button_prompt" name="survey_button_prompt" value="<?php echo htmlspecialchars($survey->survey_button_prompt); ?>" />
              </div>
