...
<body class="mdl-demo mdl-color--grey-100 mdl-color-text--grey-700 mdl-base">
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
      ...
      <div class="mdl-layout--large-screen-only mdl-layout__header-row">
        <h3>Name &amp; Title <button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored mdl-shadow--4dp mdl-color--accent" id="add">
        ...
        <?php if (!empty($survey) && $survey instanceof Survey) : ?>
          <form id="survey_form" action="survey_form.php" method="post">
            ...
            <div class="input_form big widelabels">
              ...
              <?php endforeach; ?>
              <button id="submitButton" class="mdc-button foo-button" name="submitButton">
